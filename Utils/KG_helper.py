...
def get_combined_results(left_results, right_results):
	...
	# print("++++++++++++++++++++++++")
	# print("The left result is {}".format(results['left_hits@10']))
	# print("The right result is {}".format(results['right_hits@10']))
	# print("++++++++++++++++++++++++")
	return results
...
def cconv(a, b):
	...
	return torch.fft.irfft(
		com_mult(torch.fft.rfft(a, dim=-1), torch.fft.rfft(b, dim=-1)),
		n=a.shape[-1],
		dim=-1,
	)
